...
const Home = ({user,setLoadQuiz,setTopic}) => {
  ...
  return (
    <div className='home-page'>
      ...
      <div className='card-bar'>
        <Link to={user?"/quizpallet":"/login"} style={{textDecoration:"none"}} onClick={()=>setTopic("SQL")}><Card topic="SQL" image={sql}/></Link>
        <Link to={user?"/quizpallet":"/login"} style={{textDecoration:"none"}} onClick={()=>setTopic("DBMS")}><Card topic="DBMS" image={react}/></Link>
        <Link to={user?"/quizpallet":"/login"} style={{textDecoration:"none"}} onClick={()=>setTopic("PYTHON")}><Card topic="Python" image={python}/></Link>
        <Link to={user?"/quizpallet":"/login"} style={{textDecoration:"none"}} onClick={()=>setTopic("JAVA")}><Card topic="Java" image={java}/></Link>
      </div>
