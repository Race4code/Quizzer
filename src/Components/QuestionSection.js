...
const QuestionSection = ({currentQuestion,setCurrentQuestion,questionSet,setQuestionSet,answers,setAnswers}) => {
...
// const handleSave=()=>{
//     const temp = [...questionSet]
//     temp[currentQuestion.id-1].status="save"
//     const temp1 = questionSet[currentQuestion.id]
//     setCurrentQuestion(temp1)
//     setQuestionSet(temp)
// }

// const handleReview=()=>{
//   const temp = [...questionSet]
//   temp[currentQuestion.id-1].status="review"
//   const nextQuestion = questionSet[currentQuestion.id]
//   setCurrentQuestion(nextQuestion)
//   setQuestionSet(temp)
// }
...
// const handleNext=()=>{
//   const temp = questionSet[currentQuestion.id]
//   const temp1 = [...questionSet]
//   if(temp1[currentQuestion.id-1].status==="not visited")
//     temp1[currentQuestion.id-1].status="visited"
//   setQuestionSet(temp1)
//   setCurrentQuestion(temp)
// }
...
// handle select 
    ...
    //     const temp = [...questionSet]
    //     if(currentQuestion.options[index].isSelected){
    //         const tempOpt = temp[currentQuestion.id-1].options.map((opt)=>{
    //             opt.isSelected=false
    //             return opt
    //         })     
    //         temp[currentQuestion.id-1].options = tempOpt
    //         setQuestionSet(temp)
    //         setChoose(!choose)
    //         return
    //     }
    //     const tempOpt = temp[currentQuestion.id-1].options.map((opt,ind)=>{
    //       if(ind===index) opt.isSelected=true
